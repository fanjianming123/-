    ...
    >
      ...
      >
        ...
        <span class="dialog-footer">
          <dkd-button user="sure" @click="sureAdvice" v-if="!isAdd"
            >采纳建议</dkd-button
          >
          <dkd-button user="sure" @click="sureAdd()" v-if="isAdd"
            >确定</dkd-button
          >
        </span>
      </el-dialog>
      ...
      <span slot="footer" class="dialog-footer">
        <dkd-button user="sure" @click="sureChangeChannel">确定</dkd-button>
      </span>
    </el-dialog>
  </div>
</template>
